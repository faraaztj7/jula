...
<div id="htmove-gopro-popup" class="htmove-gopro-popup">
    ...
    <div class="htmove-gopro-popup-content">
        <div class="htmove-gopro-popup-content-inner">
            ...
            <a href="<?php echo esc_url('https://moveaddons.com/pricing/?utm_source=freeversion&utm_medium=dashboard&utm_campaign=getpro');?>" class="htmove-admin-btn" target="_blank"><?php esc_html_e( 'PURCHASE NOW', 'moveaddons' ); ?></a>
        </div>
    </div>
</div>