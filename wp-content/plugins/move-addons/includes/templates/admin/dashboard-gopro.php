...
<div id="htmove-tab-content-gopro" class="htmove-admin-tab-pane">
    ...
    <div class="htmove-tab-head">
        ...
        <div class="htmove-tab-head-right">
            <a href="<?php echo esc_url('https://moveaddons.com/pricing/?utm_source=freeversion&utm_medium=dashboard&utm_campaign=getpro');?>" class="htmove-admin-btn" target="_blank"><?php esc_html_e( 'Buy Move Pro', 'moveaddons' ); ?></a>
        </div>
    </div>
    <!-- Head End -->
