...
class Shop_Product_Grid_Element extends Base {
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'area_attr', 'class', 'htmove-product-grid htmove-row htmove-product-grid-'.esc_attr($settings['layout']) );
    ...
    public function get_products_content( $args, $settings ){
        ...
        // Badge Text
        $onsale_badge = !empty( $settings['sale_badge_txt'] ) ? $settings['sale_badge_txt'] : esc_html__('Sale!','moveaddons');
        $feature_badge = !empty( $settings['hot_badge_txt'] ) ? $settings['hot_badge_txt'] : esc_html__('Hot!','moveaddons');
                    ...
                    <div class="htmove-product htmove-product-<?php echo $settings['layout']; ?>">
                        <div class="htmove-product-thumbnail">
                            ...
                            <ul class="htmove-product-action htmove-product-action-primary">
                                ...
                                ?>
                                <li>
                                    <a href="#" class="htmove-product-action-btn movequickview" data-quickid="<?php echo esc_attr($product->get_id()); ?>">
                                        <i class="fas fa-search"></i>
                                    </a>
                                </li>
                            </ul>
                            <?php if( $settings['layout'] == 'three' ): ?>
                                <a href="<?php echo $product->add_to_cart_url(); ?>" data-quantity="1" class="<?php echo esc_attr($btn_class); ?>" data-product_id="<?php echo esc_attr($product->get_id()); ?>"><?php echo __( $cart_btn, 'moveaddons' );?></a>
                            <?php endif;?>
                        </div>
                        <div class="htmove-product-content">
                            ...
                            <h4 class="htmove-product-heading">
                                <a href="<?php echo $product->get_permalink(); ?>" class="htmove-product-title"><?php echo esc_html( $product->get_title() ); ?></a>
                                <?php if( $settings['layout'] != 'three' ): ?>
                                    <a href="<?php echo $product->add_to_cart_url(); ?>" data-quantity="1" class="<?php echo esc_attr($btn_class); ?>" data-product_id="<?php echo esc_attr($product->get_id()); ?>"><?php echo __( $cart_btn, 'moveaddons' );?></a>
                                <?php endif; ?>
                            </h4>
