...
class Advanced_Tab_Element extends Base {
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'area_attr', 'class', 'htmove-advance-tab htmove-advance-tab-'.esc_attr($settings['menu_layout']) );
                        ...
                        if( is_array( $tabs_list ) ){
                            ...
                            foreach ( $tabs_list as  $tab_item ){
                                ...
                                if( !empty( $tab_item['menu_icon']['value'] ) ){
                                    echo '<li><a href="#htmove-advance-tab-'.esc_attr($j.$id).'">'.move_addons_render_icon( $tab_item,'menu_icon', 'menuicon' ).esc_html__( $tab_item['menu_title'], 'moveaddons' ).'</a></li>';
                                }else{
                                    echo '<li><a href="#htmove-advance-tab-'.esc_attr($j.$id).'">'.esc_html__( $tab_item['menu_title'], 'moveaddons' ).'</a></li>';
                                }
                            }
                        }
                    ?>
                ...
                <div class="htmove-tab-container">
                    <?php
                        if( is_array( $tabs_list ) ){
                            ...
                            foreach ( $tabs_list as  $tab_item ){
                                $i++;
                                echo '<div id="htmove-advance-tab-'.esc_attr($i.$id).'" class="htmove-tab-pane">';
