...
class Recent_Blog_Element extends Base {
    ...
    public function get_style_depends() {
        return [ 'move-swiper', 'elementor-icons-shared-0-css','elementor-icons-fa-brands','elementor-icons-fa-regular','elementor-icons-fa-solid','move-recentblog' ];
    }
    ...
    protected function render( $instance = [] ) {
        ...
        $this->add_render_attribute( 'item_attr', 'class', 'htmove-blog htmove-blog-'.esc_attr($settings['blog_style']) );
