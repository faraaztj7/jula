...
class Banner_Element extends Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'area_border',
                    'label' => esc_html__( 'Borderdddd', 'moveaddons' ),
            ...
            $this->add_control(
                'banner_area_image_overlay_heading',
                [
                    'label' => __( 'Image Overlay', 'moveaddons' ),
            ...
            $this->add_group_control(
                ...
                [
                    'name' => 'banner_area_image_overlay',
                    'label' => __( 'Background', 'moveaddons' ),
                    'types' => [ 'classic', 'gradient' ],
                    'selector' => '{{WRAPPER}} .htmove-banner .htmove-banner-thumb:after',
    ...
    protected function render( $instance = [] ) {
        ...
        if( $settings['banner_style'] == 'eight' ){
            ...
            $this->add_render_attribute( 'area_attr', 'class', 'htmove-banner-'.esc_attr($settings['banner_style']) );
        }
        $this->add_render_attribute( 'area_attr', 'class', 'position-'.esc_attr($settings['banner_content_pos']) );
        ...
        if( !empty( $settings['button_icon']['value'] ) ){
            ...
            $this->add_render_attribute( 'area_attr', 'class', 'htmove-button-icon-'.esc_attr($settings['button_icon_align']) );
                    ...
                    <div class="htmove-banner-content">
                        <?php
                            if( !empty( $settings['banner_sub_title'] ) && $settings['banner_sub_title_pos'] === 'before' ){
                                echo '<span class="htmove-banner-sub-title">'. esc_html($settings['banner_sub_title']).'</span>'; 
                            }
                            if( !empty( $settings['banner_title'] ) ){
                                echo '<h2 class="htmove-banner-title">'. esc_html($settings['banner_title']).'</h2>'; 
                            }
                            if( !empty( $settings['banner_sub_title'] ) && $settings['banner_sub_title_pos'] == 'after' ){
                                echo '<span class="htmove-banner-sub-title">'. esc_html($settings['banner_sub_title']).'</span>'; 
                            }
                            if( !empty( $settings['banner_description'] ) ){
                                echo '<p>'. esc_html($settings['banner_description']).'</p>'; 
                            }
                        ?>
                    </div>
                <?php endif; ?>
